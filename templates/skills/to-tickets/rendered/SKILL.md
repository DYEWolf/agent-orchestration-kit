...
Publish the approved tickets. **How** depends on the tracker `docs/agents/issue-tracker.md` configured; the tickets are the same either way, only the shape of the blocking edges changes:
